        ...
        <div className="lg:col-span-2 col-span-full md:col-span-3 md:border-r border-[#1E2D3D] px-0 md:px-5 md:py-4 py-0 flex flex-col gap-4 overflow-hidden">
          ...
          >
            ...
            <div className="flex items-center gap-6 ">
              <button
                className={`flex items-center gap-2.5 cursor-pointer transition-colors hover:text-white w-full ${
                  filter === "Excel" ? "text-white" : "text-[#607B96]"
                }`}
            ...
            <div className="flex items-center gap-6">
              <button
                className={`flex items-center gap-2.5 cursor-pointer transition-colors hover:text-white w-full ${
                  filter === "SQL" ? "text-white" : "text-[#607B96]"
                }`}
            ...
            <div className="flex items-center gap-6">
              <button
                className={`flex items-center gap-2.5 cursor-pointer transition-colors hover:text-white w-full ${
                  filter === "Tableau" ? "text-white" : "text-[#607B96]"
                }`}
            ...
            <div className="flex items-center gap-6">
              <button
                className={`flex items-center gap-2.5 cursor-pointer transition-colors hover:text-white w-full ${
                  filter === "Photoshop" ? "text-white" : "text-[#607B96]"
                }`}
            ...
            <div className="flex items-center gap-6">
              <button
                className={`flex items-center gap-2.5 cursor-pointer transition-colors hover:text-white w-full ${
                  filter === "PremierPro" ? "text-white" : "text-[#607B96]"
                }`}
                onClick={() => setFilter("PremierPro")}
              >
                <SiAdobepremiere />
...
const Card = ({ data }) => {
  ...
  function generateIcon(value) {
    ...
    if (value.includes("Photoshop")) {
      return <DiPhotoshop />;
    }
    if (value.includes("Tableau")) {
      return <SiTableau />;
    }
    if (value.includes("PremierPro")) {
      return <SiAdobepremiere />;
    }
